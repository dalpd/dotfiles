...
myXPromptConfig = XPC
  ...
  where
    ...
    myFont = "xft:Victor Mono:style=Italic:size=28"
...
myStartupHook = do
  ...
  spawnOnce "autorandr profesorler"
  setRandomBackground
